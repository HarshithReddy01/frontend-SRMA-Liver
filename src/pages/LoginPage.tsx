            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <button 
                  ...
                  disabled={true}
                  className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-gray-200 dark:bg-gray-700 text-gray-500 dark:text-gray-400 text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
                >
                  <FcGoogle className="w-5 h-5 mr-2 opacity-50" />
